 ...
 * This file demonstrates how to integrate Apexlens with a web frontend
 */

// For React/Vue/Angular applications
export class ApexlensClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ApexlensClient(provider, contractAddress);
